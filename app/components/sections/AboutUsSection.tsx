  ...
  return (
    <section id="about" className="bg-brand-black">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-32">
        ...
        >
            <span className="text-brand-orange font-bold uppercase tracking-widest text-xs">Our Profile</span>
      ...
      <TextRevealByWord 
        text="JBS Cargo Movers is a professionally managed logistics and cargo service company established in 2023 with the vision of providing reliable, secure, fast, and cost-effective logistics solutions across India. Based in New Delhi, we specialize in Air, Surface, and Train Cargo, alongside Consolidation and Manpower Solutions."
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
            ...
            >
                <div className="p-8 bg-white/5 border border-white/10 rounded-3xl space-y-4">
                    <h3 className="text-xl font-bold text-white">Operational Strength</h3>
                    <p className="text-white/40 text-sm leading-relaxed">
                        Our operational capabilities are further strengthened through our associated organization, <span className="text-brand-orange font-bold">Move Zen Express Logistics Pvt. Ltd.</span>, providing additional expertise in transport and logistics management.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="p-6 bg-white/5 border border-white/10 rounded-2xl">
                        ...
                        <p className="text-white/40 text-[10px] uppercase font-bold tracking-widest mt-2">Destinations</p>
                    </div>
                    <div className="p-6 bg-white/5 border border-white/10 rounded-2xl">
                        <p className="text-3xl font-black text-brand-orange">24/7</p>
                        <p className="text-white/40 text-[10px] uppercase font-bold tracking-widest mt-2">Support</p>
                    </div>
                </div>
            </motion.div>
        </div>
